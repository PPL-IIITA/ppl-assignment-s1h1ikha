...
public class RandomGenerator {
        public static void GenerateBG(String boysFile , String girlsFile){      //randomly generating boys and girls
            for(int i=1 ; i<=20 ; i++){
        ...
        public static void GenerateGift(String giftFile){                         //randomly generating gifts
            for(int i=1 ; i<=20 ; i++){
                Random rand = new Random();
